...
tape_1.default("headerFrame", function (t) {
    ...
    t.deepEqual(encoder_1.header(0xff, true, true, true), Buffer.from([0x82, 0x7f, 0x00, 0xff]));
    t.deepEqual(encoder_1.header(0x7e, true, true, true), Buffer.from([0x82, 0x7e]));
    t.deepEqual(encoder_1.header(0x7f, true, true, true), Buffer.from([0x82, 0x7f, 0x00, 0x7f]));
    t.end();
});

...
function wscat(host, port) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var _a, stdout, stdin, stderr, connected;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = child_process_1.spawn("nc", [host, port + ""]), stdout = _a.stdout, stdin = _a.stdin, stderr = _a.stderr;
                    ...
                    return [4 /*yield*/, connected];
                case 1:
                    _b.sent();
                    return [2 /*return*/, { stdout: stdout, stdin: stdin, stderr: stderr }];
            }
        });
    });
}
